...
public class CustomerInfo {
  ...
  * @throws IOException if the JSON Element is invalid with respect to CustomerInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomerInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("customerEntryId") != null && !jsonObj.get("customerEntryId").isJsonNull()) && !jsonObj.get("customerEntryId").isJsonPrimitive()) {
