...
public class DeviceRiskFactorsResponse {
  ...
  private List<DeviceRiskFactors> items;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, deviceRiskFactorsResponse.items);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceRiskFactorsResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceRiskFactorsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeviceRiskFactorsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeviceRiskFactorsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            DeviceRiskFactors.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
