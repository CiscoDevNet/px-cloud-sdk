...
public class FaultsSummary {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FaultsSummary
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FaultsSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FaultsSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FaultsSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("supportedProductSeries") != null && !jsonObj.get("supportedProductSeries").isJsonNull()) && !jsonObj.get("supportedProductSeries").isJsonPrimitive()) {
