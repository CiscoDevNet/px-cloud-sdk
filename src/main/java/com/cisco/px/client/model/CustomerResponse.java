...
public class CustomerResponse {
  ...
  public CustomerResponse items(List<Customer> items) {
    this.items = items;
    return this;
  }

  public CustomerResponse addItemsItem(Customer itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, customerResponse.items) &&
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Customer.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
