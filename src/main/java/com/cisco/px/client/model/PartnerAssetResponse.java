...
public class PartnerAssetResponse {
  ...
  private List<PartnerAsset> items;
  ...
  public PartnerAssetResponse items(List<PartnerAsset> items) {
    this.items = items;
    return this;
  }

  public PartnerAssetResponse addItemsItem(PartnerAsset itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<PartnerAsset> getItems() {
    return items;
  }

  public void setItems(List<PartnerAsset> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, partnerAssetResponse.items) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to PartnerAssetResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PartnerAssetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PartnerAssetResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PartnerAssetResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            PartnerAsset.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
