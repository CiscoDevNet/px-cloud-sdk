...
public class ViolationSummary {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ViolationSummary
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViolationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViolationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ViolationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("policyGroupId") != null && !jsonObj.get("policyGroupId").isJsonNull()) && !jsonObj.get("policyGroupId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("policyGroupName") != null && !jsonObj.get("policyGroupName").isJsonNull()) && !jsonObj.get("policyGroupName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("policyCategory") != null && !jsonObj.get("policyCategory").isJsonNull()) && !jsonObj.get("policyCategory").isJsonPrimitive()) {
