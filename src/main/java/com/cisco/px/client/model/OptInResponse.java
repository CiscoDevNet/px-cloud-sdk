...
public class OptInResponse {
  ...
  **/
  ...
  public OptInResponse hasQualifiedAssets(Boolean hasQualifiedAssets) {
  ...
  **/
  @javax.annotation.Nullable
  public Boolean getHasQualifiedAssets() {
    return hasQualifiedAssets;
  }

  public void setHasQualifiedAssets(Boolean hasQualifiedAssets) {
    this.hasQualifiedAssets = hasQualifiedAssets;
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to OptInResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OptInResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OptInResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptInResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
