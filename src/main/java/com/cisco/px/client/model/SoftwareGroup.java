...
public class SoftwareGroup {
  ...
  **/
  ...
  public SoftwareGroup suggestionId(String suggestionId) {
  ...
  **/
  ...
  public SoftwareGroup managedBy(String managedBy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assetCount, softwareGroup.assetCount) &&
        ...
        Objects.equals(this.suggestionId, softwareGroup.suggestionId) &&
        ...
        Objects.equals(this.managedBy, softwareGroup.managedBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(assetCount, sourceId, sourceSystemId, selectedRelease, productFamily, softwareGroupName, softwareGroupId, suggestionId, suggestions, riskLevel, softwareType, currentReleases, managedBy);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SoftwareGroup
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SoftwareGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SoftwareGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SoftwareGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("softwareGroupName") != null && !jsonObj.get("softwareGroupName").isJsonNull()) && !jsonObj.get("softwareGroupName").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("softwareGroupId") != null && !jsonObj.get("softwareGroupId").isJsonNull()) && !jsonObj.get("softwareGroupId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("suggestionId") != null && !jsonObj.get("suggestionId").isJsonNull()) && !jsonObj.get("suggestionId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `suggestionId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("suggestionId").toString()));
      }
      ...
      if ((jsonObj.get("currentReleases") != null && !jsonObj.get("currentReleases").isJsonNull()) && !jsonObj.get("currentReleases").isJsonPrimitive()) {
