...
public class SimilarDeviceData {
  ...
  **/
  ...
  public SimilarDeviceData assetUniqueId(String assetUniqueId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assetId, similarDeviceData.assetId) &&
        Objects.equals(this.assetUniqueId, similarDeviceData.assetUniqueId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assetId, assetUniqueId, assetName, productFamily, productId, softwareRelease, softwareType, risk, serialNumber, similarityScore);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SimilarDeviceData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SimilarDeviceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimilarDeviceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimilarDeviceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
