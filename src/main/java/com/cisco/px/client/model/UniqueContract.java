...
public class UniqueContract {
  ...
  public static final String SERIALIZED_NAME_CX_S_U_A_EMAIL_ID = "cxSUAEmailId";
  @SerializedName(SERIALIZED_NAME_CX_S_U_A_EMAIL_ID)
  private String cxSUAEmailId;
  ...
  public static final String SERIALIZED_NAME_SERVICE_LEVELS = "serviceLevels";
  @SerializedName(SERIALIZED_NAME_SERVICE_LEVELS)
  ...
  public static final String SERIALIZED_NAME_SERVICE_PROGRAMS = "servicePrograms";
  @SerializedName(SERIALIZED_NAME_SERVICE_PROGRAMS)
  private List<String> servicePrograms;

  public UniqueContract() {
  }

  public UniqueContract contractNumber(String contractNumber) {
  ...
  **/
  ...
  public UniqueContract currency(String currency) {
  ...
  **/
  ...
  public UniqueContract contractStatus(String contractStatus) {
  ...
  **/
  ...
  public UniqueContract contractValue(Long contractValue) {
  ...
  **/
  ...
  public UniqueContract cxSUAEmailId(String cxSUAEmailId) {
    this.cxSUAEmailId = cxSUAEmailId;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public String getCxSUAEmailId() {
    return cxSUAEmailId;
  }

  public void setCxSUAEmailId(String cxSUAEmailId) {
    this.cxSUAEmailId = cxSUAEmailId;
  }


  public UniqueContract coverageStartDate(String coverageStartDate) {
  ...
  **/
  ...
  public UniqueContract coverageEndDate(String coverageEndDate) {
  ...
  **/
  ...
  public UniqueContract customerDetails(List<CustomerDetails> customerDetails) {
    this.customerDetails = customerDetails;
    return this;
  }

  public UniqueContract addCustomerDetailsItem(CustomerDetails customerDetailsItem) {
  ...
  **/
  ...
  public UniqueContract serviceLevels(List<String> serviceLevels) {
    this.serviceLevels = serviceLevels;
    return this;
  }

  public UniqueContract addServiceLevelsItem(String serviceLevelsItem) {
    if (this.serviceLevels == null) {
      this.serviceLevels = new ArrayList<>();
    }
    this.serviceLevels.add(serviceLevelsItem);
    return this;
  }
  ...
  **/
  ...
  public UniqueContract successTrackIds(List<Long> successTrackIds) {
    this.successTrackIds = successTrackIds;
    return this;
  }

  public UniqueContract addSuccessTrackIdsItem(Long successTrackIdsItem) {
  ...
  **/
  ...
  public UniqueContract onboardedStatus(Long onboardedStatus) {
  ...
  **/
  ...
  public UniqueContract servicePrograms(List<String> servicePrograms) {
    this.servicePrograms = servicePrograms;
    return this;
  }

  public UniqueContract addServiceProgramsItem(String serviceProgramsItem) {
    if (this.servicePrograms == null) {
      this.servicePrograms = new ArrayList<>();
    }
    this.servicePrograms.add(serviceProgramsItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UniqueContract uniqueContract = (UniqueContract) o;
    return Objects.equals(this.contractNumber, uniqueContract.contractNumber) &&
        Objects.equals(this.currency, uniqueContract.currency) &&
        Objects.equals(this.contractStatus, uniqueContract.contractStatus) &&
        Objects.equals(this.contractValue, uniqueContract.contractValue) &&
        Objects.equals(this.cxSUAEmailId, uniqueContract.cxSUAEmailId) &&
        Objects.equals(this.coverageStartDate, uniqueContract.coverageStartDate) &&
        Objects.equals(this.coverageEndDate, uniqueContract.coverageEndDate) &&
        Objects.equals(this.customerDetails, uniqueContract.customerDetails) &&
        Objects.equals(this.serviceLevels, uniqueContract.serviceLevels) &&
        Objects.equals(this.successTrackIds, uniqueContract.successTrackIds) &&
        Objects.equals(this.onboardedStatus, uniqueContract.onboardedStatus) &&
        Objects.equals(this.servicePrograms, uniqueContract.servicePrograms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contractNumber, currency, contractStatus, contractValue, cxSUAEmailId, coverageStartDate, coverageEndDate, customerDetails, serviceLevels, successTrackIds, onboardedStatus, servicePrograms);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UniqueContract {\n");
    ...
    sb.append("    cxSUAEmailId: ").append(toIndentedString(cxSUAEmailId)).append("\n");
    ...
    sb.append("    serviceLevels: ").append(toIndentedString(serviceLevels)).append("\n");
    ...
    sb.append("    servicePrograms: ").append(toIndentedString(servicePrograms)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UniqueContract
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UniqueContract.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniqueContract is not found in the empty JSON string", UniqueContract.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UniqueContract.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UniqueContract` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("cxSUAEmailId") != null && !jsonObj.get("cxSUAEmailId").isJsonNull()) && !jsonObj.get("cxSUAEmailId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cxSUAEmailId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cxSUAEmailId").toString()));
      }
      ...
      if (jsonObj.get("serviceLevels") != null && !jsonObj.get("serviceLevels").isJsonNull() && !jsonObj.get("serviceLevels").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `serviceLevels` to be an array in the JSON string but got `%s`", jsonObj.get("serviceLevels").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("servicePrograms") != null && !jsonObj.get("servicePrograms").isJsonNull() && !jsonObj.get("servicePrograms").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `servicePrograms` to be an array in the JSON string but got `%s`", jsonObj.get("servicePrograms").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniqueContract.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniqueContract' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniqueContract> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniqueContract.class));

       return (TypeAdapter<T>) new TypeAdapter<UniqueContract>() {
           @Override
           public void write(JsonWriter out, UniqueContract value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UniqueContract read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UniqueContract given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniqueContract
  * @throws IOException if the JSON string is invalid with respect to UniqueContract
  */
  public static UniqueContract fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniqueContract.class);
  }

 /**
  * Convert an instance of UniqueContract to an JSON string
  *
  * @return JSON string
  */
